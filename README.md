# nvim-treesitter-queries-hoon

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-hoon/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-hoon/actions/workflows/validate.yml)

Neovim tree-sitter queries for **hoon**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-hoon",
...
- [ ] Changes are scoped to `hoon` — do not include files for other languages
